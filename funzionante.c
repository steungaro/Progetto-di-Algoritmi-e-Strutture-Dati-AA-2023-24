...
ordine_t* cucina(magazzino_hash_t* magazzino, ordine_t* codaordini, ordine_t** codaprodotti, ordine_t **last, int tipo) { //dopo l'aggiunta di un ordine o dopo il rifornimento va avviata: controlla gli elementi della coda ordini e prepara quelli i cui ingredienti sono disponibili nel magazzino, restituisce la nuova coda ordini e modifica la coda prodotti passata
    int cucinabile;
