...
ordine_t* cucina(magazzino_hash_t* magazzino, ordine_t* codaordini, ordine_t **last, ordine_t** albero_prodotti, int tipo) { //se di tipo 1 controlla solo l'ultimo, se di tipo 0 controlla tutti gli ordini e vede se sono cucinabili, in tal caso li cucina
    int cucinabile;
